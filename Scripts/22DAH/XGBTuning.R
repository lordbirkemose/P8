...
### Data ---------------------------------------------------------------------
data <- funGetDataHAR_v2(DAH = 22, model = "extended", test = FALSE)
dataLog <- funGetDataHAR_v2(DAH = 22, model = "extendedLog")
...
save(paramTuningXGB, file = "./Rdata/22DAH/paramTuningXGB.RData")
...
save(paramTuningXGBLog, file = "./Rdata/22DAH/paramTuningXGBLog.RData")
...
save(paramTuningXGBBase, file = "./Rdata/22DAH/paramTuningXGBBase.RData")
...
save(paramTuningXGBBaseLog, file = "./Rdata/22DAH/paramTuningXGBBaseLog.RData")
